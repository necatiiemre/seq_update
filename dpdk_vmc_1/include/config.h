...
#define PACKET_TRACE_VL_IDX_TX 160    // Izlenecek VL-IDX (TX tarafinda, remap oncesi)
#define PACKET_TRACE_VL_IDX_RX 128    // Izlenecek VL-IDX (RX tarafinda, remap sonrasi: 160-32=128)
